...
<https://github.com/frec3044/lake-ice/issues>
...
## Instructions
  ...
  - Open the notebook `assignment/lake-ice-part1.qmd` in RStudio
...
1-week (2 75-minute class periods are allocated to this module) if only doing part 1.

The background reading is embbed in the assignment Quarto as links to the relevant sections of [R for Data Science book (2nd edition)](https://r4ds.hadley.nz) by Hadley Wickham, Mine Çetinkaya-Rundel, and Garrett Grolemund.
