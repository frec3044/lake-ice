...
dataset.  We are going to focus on the following lakes:  `Baikal`, `Cazenovia`, `Mendota`,`Monona`, `Oneida`, `Sunapee` `Wingra`.  Use the `%in%` function to filter the dataset.
...
-   What is the distribution of the slopes for the different lake? Are they all
    the same sign?
-   What lake showing the fastest rate of change in ice cover?
