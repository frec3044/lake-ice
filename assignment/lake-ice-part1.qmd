...
- Calculate the 90% predictive interval by using the`quantile` function to determine the 5% and 95% quantile for your residuals in Question 6 (the 5% should be a negative number and the 95% should be a positive number because your residuals are centered around 0).  You will use the vector of residuals from Question 6 in your calculation.
- Add lower predictive interval (a negative number) and the upper predictive interval (a positive number) to your prediction for 2040 to calculate the 90% predictive interval around your prediction (provide your answer). 
- How wide is your predictive interval (number of days)?
